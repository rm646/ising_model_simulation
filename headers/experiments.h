...
//Outputs the spins in format appropriate for gnuplot at the time t_eq
void snapshot(int spins[Ni][Nj], int t_eq,  gsl_rng* r_bolt, gsl_rng* r_spin, const double T);
